...
import {
  ...
  PROSCKURA_YURIY_BOAST1, PROSCKURA_YURIY_EMAIL, PROSCKURA_YURIY_FB, PROSCKURA_YURIY_LIFE, PROSCKURA_YURIY_NAME, PROSCKURA_YURIY_ROLE,
...
export class CardComponent implements OnInit {
  ...
  prosckura_yuriy_boast = `${PROSCKURA_YURIY_BOAST1}`;
