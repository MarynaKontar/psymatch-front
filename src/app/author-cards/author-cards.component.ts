...
import {
  ...
  BOAST_HEADER,
  LIFE_HEADER,
  WHY_IN_PROJECT_HEADER,
  PROSCKURA_YURIY_NAME,
  PROSCKURA_YURIY_ROLE,
  PROSCKURA_YURIY_WHY_IN_PROJECT,
  PROSCKURA_YURIY_LIFE,
  PROSCKURA_YURIY_BOAST1,
  PROSCKURA_YURIY_BOAST2,
  PROSCKURA_YURIY_BOAST3,
  PROSCKURA_YURIY_LINK_NAME_UPA,
  PROSCKURA_YURIY_LINK_UPA,
  PROSCKURA_YURIY_LINK_NAME_PSYMETRICS,
  PROSCKURA_YURIY_LINK_PSYMETRICS,
  PROSCKURA_YURIY_LINK_NAME_TEST_CONSTRUCTOR,
  PROSCKURA_YURIY_LINK_TEST_CONSTRUCTOR,
  PROSCKURA_YURIY_EMAIL,
  PROSCKURA_YURIY_FB,
  KONTAR_MARYNA_NAME,
  KONTAR_MARYNA_ROLE,
  KONTAR_MARYNA_WHY_IN_PROJECT,
  KONTAR_MARYNA_LIFE,
  KONTAR_MARYNA_BOAST,
  KONTAR_MARYNA_EMAIL,
  KONTAR_MARYNA_FB,
  KONTAR_MARYNA_GITHUB,
  PROSCKURA_VITALIY_NAME,
  PROSCKURA_VITALIY_ROLE,
  PROSCKURA_VITALIY_WHY_IN_PROJECT,
  PROSCKURA_VITALIY_BOAST,
  PROSCKURA_VITALIY_EMAIL,
  PROSCKURA_VITALIY_FB,
  PROSCKURA_VITALIY_GITHUB,
  PROSCKURA_VITALIY_LIFE,
  VASYLENKO_SVETLANA_NAME,
  VASYLENKO_SVETLANA_ROLE,
  VASYLENKO_SVETLANA_WHY_IN_PROJECT,
  VASYLENKO_SVETLANA_BOAST,
  VASYLENKO_SVETLANA_EMAIL,
  VASYLENKO_SVETLANA_FB,
  VASYLENKO_SVETLANA_LIFE
} from './author-cards';
